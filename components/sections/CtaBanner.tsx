    ...
    <section className="px-3 pb-20 sm:px-5 sm:pb-28">
      <Container>
        ...
        >
          <div
            aria-hidden
            className="absolute -left-16 -top-16 h-64 w-64 rounded-full bg-gold-400/20 blur-3xl"
          />
          <div
            aria-hidden
            className="absolute -bottom-20 -right-10 h-72 w-72 rounded-full bg-glow-violet/20 blur-3xl"
          />
